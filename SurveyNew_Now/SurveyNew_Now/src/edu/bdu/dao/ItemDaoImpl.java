...
public class ItemDaoImpl extends BaseJdbcDao{
  ...
  public List getItemList(Item condition)
  {
	  ...
	  String sql = "select * from ItemTable where 1 = 1";//根据调查项所属调查问卷编号生成sql
	  ...
	  if(condition != null)
	  {
	     ...
	     {
	    	 sql += " and ItemCaption ='" + condition.getItemCaption() + "'";//设置调查项标题
	     }
	     ...
	     if(condition.getItemAttribute() != 0)
	     {
	    	 sql += " and ItemAttribute = " + condition.getItemAttribute();//获得调查项
	     }
	  }
  ...
  public boolean updateItem(Item item)
  {
	  ...
	  String updateSql = "update ItemTable set ItemAttribute = 1,ItemCaption = ?," +
