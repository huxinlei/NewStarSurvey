...
public class UserAdminIndexAction extends HttpServlet {
    /**
     * 初始化
     */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case 1:
		    ...
		    User userTen = (User)session.getAttribute("user");//获得当前用户信息
		    
	        out.println(getSurveyListTen(userTen.getUserID()));//获得调查问卷列表
	...
	private String getUserListTen()
	{
	     ...
	     for(int i = 0;i < userListSize;i++)
	     {
	         ...
	         results += "<td class='tdContent' width='30' align='center'>" + "<a href='javascript:getUserDataById(" + user.getUserID() + ")'>查看</a>" + "</td>";
	...
	//获得最新十条调查问卷
	private String getSurveyListTen(int userID)
	{
		String results = "";//获得头十条调查问卷
		
	     SurveyDaoImpl surveyOp = new SurveyDaoImpl();//调查问卷操作类
	     
	     List surveylist = surveyOp.getServeyList(userID);//获得调查问卷列表
