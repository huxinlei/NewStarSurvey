      ...
      $(function(){
            ...
            $("#searchBtn").mouseout(function () {
                if ($(this).hasClass("searchBtn1_1")) {
                    $(this).removeClass("searchBtn1_1").addClass("searchBtn1"); //当鼠标离开按钮时样式改成nav1
                }
            });
      
            //请求显示调查问卷列表
             $("#surveyList").html("<div><a href='index.jsp'>调查问卷正在加载...</a></div>");
             ...
             var request = $.ajax({ url: "anyUser/AnyUserVisitAction",
                ...
                //请求前五条调查问卷信息
              $("#surveyTopFive").html("<div><a href='index.jsp'>调查问卷正在加载...</a></div>");
              ...
              var request1 = $.ajax({ url: "anyUser/AnyUserVisitAction",
                 ...
                 request1.done(function (msg) {
                    //调查问卷提示
                    $("#surveyTopFive").html("<div style='color:#006633;font-size:16px;margin-top:5px;height:40px;line-height:40px;'><b>最新调查问卷</b></div>");
                ...
                $("#searchBtn").click(function(){
            		 ...
            		 if($("#searchTitle").val() == "")
            		 {
            		  $("#surveyList").html("<div><a href='surveyList.jsp'>搜索条件不允许为空!</a></div>");
            		  
            		  return ;
            		 }
            		 
            		 //alert($("#searchTitle").val());//获得搜索文本框中的内容
                     //根据标题搜索调查问卷
     ...
     <div align="center" style="margin:0px;padding:0px;width:100%;height:100%;">
       ...
       <div id="surveyContent">
         ...
         <div>
           ...
           <span style="margin-left:10px;"><input id="searchBtn" class="searchBtn1" type="button" value="搜索问卷"/></span>
          </div>
         ...
         <div id="surveyContentReal">
            ...
            <div id="surveyNew">
               ...
               <div id="cooperationDiv">
                 <div style="color:#006633;font-size:16px;margin-top:5px;height:40px;line-height:40px;"><b>调查问卷典型用户</b></div>
